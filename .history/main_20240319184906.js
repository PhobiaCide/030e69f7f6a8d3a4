...
function _mapWithCities(DOM, width, height, d3, projection, graticule, land, night, sphere) {
  ...
  context.beginPath(), path(land), context.fillStyle = "#113131cc", context.fill();
  context.beginPath(), path(night), context.fillStyle = "rgba(0,0,255,0.4)", context.fill(), content.strokeStyle = "rgba(0,0,255,0.9)", context.stroke();
