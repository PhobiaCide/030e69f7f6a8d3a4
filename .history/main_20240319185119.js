...
function _mapWithCities(DOM, width, height, d3, projection, graticule, land, night, sphere) {
  ...
  context.beginPath(), path(graticule), context.strokeStyle = "#eeeeee99", context.stroke(), context.fillStyle = "#ffffff66", context.fill();
  context.beginPath(), path(land), context.fillStyle = "#11313199", context.fill(), context.strokeStyle = "#113131", context.stroke();
  context.beginPath(), path(night), context.fillStyle = "rgba(0,0,255,0.4)", context.fill(), context.strokeStyle = "rgba(0,0,255,0.9)", context.stroke();
  ...
  // Draw the sphere
  context.beginPath(), path(sphere), context.strokeStyle = "#999", context.stroke();
...
function _map(DOM, width, height, d3, projection, graticule, land, night, sphere)
{
  const context = DOM.context2d(width, height);
  const path = d3.geoPath(projection, context);
  context.beginPath(), path(graticule), context.strokeStyle = "#111", context.stroke();
